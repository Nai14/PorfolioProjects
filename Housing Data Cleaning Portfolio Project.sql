...
-- To display the date without the time
...
-- Altering the data within the PropertySplitAddress and PropertySplitCity tables
...
-- Organising the values in order from 1.Address, 2.City, and 3.State
...
-- Viewing the data after having deleted all of the duplicate values
Select *
From RowNumCTE
Where row_num > 1
